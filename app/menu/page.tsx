	...
	return (
		<main className='flex min-h-screen relative flex-col items-center justify-between relative'>
			<section
				...
				<div
					className='absolute bottom-0 bg-contain w-full h-full bg-no-repeat bg-right-bottom'
					style={{
						backgroundImage: `url(/bg/pricelist-header-bottom.png)`,
					}}></div>
				<div
					className={`fixed z-20 w-full font-mono text-sm justify-center flex  lg:px-0 px-4 ${
						showHeaderBg
							? `pt-2 lg:pb-12 pb-2 bg-repeat lg:bg-contain lg:bg-[url('/bg/bg-header-menu.png')] lg:bg-transparent bg-[#88171d]`
							: `py-2 bg-[#88171d]`
					}`}>
					...
					<div className='flex max-w-5xl w-full md:flex-row flex-col lg:py-24 md:py-16 py-6'>
						<div className='md:w-1/2 w-full text-[#88171d] lg:pt-0 pt-4'>
							...
							<div className='lg:px-0 px-12 lg:pt-10 lg:pr-12 pt-12 w-full md:px-4 px-6 h-1/3 items-end flex md:text-left text-center'>
								Pilihan menu terbaik untuk Sahabat HCS. Siap dadakan 1 Jam siap
								kirim. 24 Jam melayani sepenuh hati. Setiap acara setiap saat
								Humani Catering Service siap menemani
							</div>
						</div>
        ...
        <div className='relative w-screen py-8'>
			...
			<section
				id='hcs'
				className='relative py-8 w-full bg-white text-[#88171d]'>
				<div
					className='absolute top-0 left-0 bg-contain bg-no-repeat w-full md:h-72 bg-left-top'
					style={{
						backgroundImage: `url(/bg/hcs-top-left.png)`,
					}}></div>
				<div
					className='absolute top-0 right-0 bg-contain bg-no-repeat w-full md:h-72 bg-right-top'
					style={{
						backgroundImage: `url(/bg/hcs-top-right.png)`,
					}}></div>
				<div className='px-8'>
					<h2 className='md:text-4xl text-3xl text-center font-bold'>
						HCS (Humani Catering Service)
					</h2>
				...
				<div className='relative w-full md:px-12 px-4 md:mt-36 mt-20 h-full flex flex-col items-center pt-12'>
					...
					<div className='relative md:w-48 md:h-48 w-36 h-36 bg-[#88171d] text-white rounded-full md:bottom-[7.6rem] bottom-[6rem] md:text-3xl text-2xl flex justify-center items-center'>
						Best Seller
					</div>
				</div>
				<div
					className='absolute bottom-64 left-0 bg-contain bg-no-repeat w-full md:h-72 bg-left-bottom'
					style={{
						backgroundImage: `url(/bg/hcs-bottom-left.png)`,
					}}></div>
				<div
					className='absolute bottom-64 right-0 bg-contain bg-no-repeat w-full md:h-72 bg-right-bottom'
					style={{
			...
			<section
				id='best-seller'
				className='flex w-full bg-white relative md:-mt-12 -mt-24 flex-col'>
				<Productslider
					items={bestsellers}
					size={`contain`}
					dots={false}
					className={`lg:mx-0`}
				/>
				<div className='flex md:flex-row flex-col justify-center md:space-x-8 md:space-y-0 space-y-8'></div>
				<div className='relative w-full md:px-12 px-4 md:mt-36 mt-20 h-full flex flex-col items-center pt-12'>
					<div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
					<div className='relative md:w-48 md:h-48 w-36 h-36 bg-[#88171d] text-white rounded-full md:bottom-[7.6rem] bottom-[6rem] md:text-3xl text-2xl flex justify-center items-center'>
						Nasi Box
			...
			<section
				id='best-seller'
				className='flex w-full bg-white relative -mt-12 flex-col'>
					...
					{[0, 1, 2].map((item, i) => {
						return (
							<div
								...
								<h3 className='text-center text-[#88171d] pb-2 text-xl'>
									Nasi Box
								</h3>
			...
			<section
				...
				<div className='relative w-full md:px-12 px-4 md:mt-36 mt-20 h-full flex flex-col items-center pt-12'>
					<div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
					<div className='relative md:w-48 md:h-48 w-36 h-36 bg-[#88171d] text-white rounded-full md:bottom-[7.6rem] bottom-[6rem] md:text-3xl text-2xl flex justify-center items-center text-center'>
						Tumpeng Mini
					</div>
				</div>
				<div
			...
			<section
				id='chat-wa'
				className='relative py-8 bg-white w-full'>
				<div
				...
				<div className='flex items-center flex-col pt-24'>
					<h2 className='text-[#88171d] md:text-4xl text-2xl text-center font-bold uppercase'>
						Price List
					</h2>
					<h3 className='text-[#88171d] md:text-2xl text-xl text-center font-bold mt-2'>
						Humani Catering Service
					</h3>
			...
			<section
				...
				<div className='flex max-w-5xl w-full md:justify-between items-center  md:flex-row flex-col md:space-x-20 space-y-4'>
					<div className='md:w-1/3 w-1/2 md:py-16 pt-16 pb-8'>
						<h3 className='text-center text-[#88171d] font-bold text-xl pb-2'>
							Kerupuk Udang
						</h3>
