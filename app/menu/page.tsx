    ...
    <main className="flex min-h-screen relative flex-col items-center justify-between">
      <section id="wellcome" className='relative w-full h-screen flex flex-col'>
        ...
        <div className="fixed z-20 w-full font-mono text-sm justify-center flex py-2 bg-[#88171d] lg:px-0 px-4"> 
          <div className='absolute -bottom-12 bg-contain w-full h-full bg-no-repeat bg-right-bottom' style={{
              backgroundImage: `url(/bg/pricelist-header-top.png)`,
            }}></div> 
      ...
      <section id="review-top" className='relative'>
        ...
        <div className='relative w-screen py-8'>
            <Slickslider images={review} size="contain" centerMode={false} slidesToShow={5} dots={false} className={`lg:mx-4`}></Slickslider>
        </div>
      </section>
      <section id="hcs" className='relative py-8 w-full bg-white text-[#88171d]'>
        ...
        <div className='relative w-full px-12 mt-36 h-full flex flex-col items-center pt-12'>
            <div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
            <div className='relative w-48 h-48 bg-[#88171d] text-white rounded-full bottom-[7.6rem] text-3xl flex justify-center items-center'>Best Seller</div>
        </div>
      ...
      <section id='best-seller' className='flex w-full bg-white relative -mt-12 flex-col'>
            ...
            <div className='relative w-full px-12 mt-36 h-full flex flex-col items-center pt-12'>
                <div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
                <div className='relative w-48 h-48 bg-[#88171d] text-white rounded-full bottom-[7.6rem] text-3xl flex justify-center items-center'>Nasi Box</div>
            </div>
            <div className='absolute bottom-64 left-0 bg-contain bg-no-repeat w-full md:h-72 bg-left-bottom' style={{
              backgroundImage: `url(/bg/hcs-bottom-left.png)`,
            }}></div>
      ...
      <section id='best-seller' className='flex w-full bg-white relative -mt-12 flex-col'>
            ...
            <div className='relative w-full px-12 mt-36 h-full flex flex-col items-center pt-12'>
                <div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
                <div className='relative w-48 h-48 bg-[#88171d] text-white rounded-full bottom-[7.6rem] text-3xl flex justify-center items-center'>Nasi Besek</div>
            </div>
            <div className='absolute bottom-64 left-0 bg-contain bg-no-repeat w-full md:h-72 bg-left-bottom' style={{
              backgroundImage: `url(/bg/hcs-bottom-left.png)`,
            }}></div>
      ...
      <section id='best-seller' className='flex w-full bg-white relative -mt-12 flex-col'>
            ...
            <div className='relative w-full px-12 mt-36 h-full flex flex-col items-center pt-12'>
                <div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
                <div className='relative w-48 h-48 bg-[#88171d] text-white rounded-full bottom-[7.6rem] text-3xl flex justify-center items-center text-center'>Tumpeng Mini</div>
            </div>
            <div className='absolute bottom-64 left-0 bg-contain bg-no-repeat w-full md:h-72 bg-left-bottom' style={{
              backgroundImage: `url(/bg/hcs-bottom-left.png)`,
            }}></div>
      ...
      <section id='best-seller' className='flex w-full bg-white relative -mt-12 flex-col'>
            ...
            <div className='relative w-full px-12 mt-36 h-full flex flex-col items-center pt-12'>
                <div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
                <div className='relative w-48 h-48 bg-[#88171d] text-white rounded-full bottom-[7.6rem] text-3xl flex justify-center items-center'>Gift Box</div>
            </div>
            <div className='absolute bottom-64 left-0 bg-contain bg-no-repeat w-full md:h-72 bg-left-bottom' style={{
              backgroundImage: `url(/bg/hcs-bottom-left.png)`,
            }}></div>
      ...
      <section id='best-seller' className='flex w-full bg-white relative -mt-12 flex-col'>
            ...
            <div className='relative w-full px-12 mt-36 h-full flex flex-col items-center pt-12'>
                <div className='relative w-full h-12 rounded-full bg-[#88171d]'></div>
                <div className='relative w-48 h-48 bg-[#88171d] text-white rounded-full bottom-[7.6rem] text-3xl flex justify-center items-center text-center'>Snack Box Series</div>
            </div>
            <div className='absolute bottom-64 left-0 bg-contain bg-no-repeat w-full md:h-72 bg-left-bottom' style={{
              backgroundImage: `url(/bg/hcs-bottom-left.png)`,
            }}></div>
